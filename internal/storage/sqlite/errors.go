...
var (
	...
	ErrInvalidOwnerID            = errors.New("owner id must be > 0")
	ErrBlogsByUserID             = errors.New("could not get blogs by user id")
	ErrLatestPublicPosts         = errors.New("could not get latest public posts")
